...
class _AuthFormState extends State<AuthForm> {
  ...
  void _trySubmit() async {
    ...
    prefs.setString("carePassword", _userPassword);
    prefs.setString("careEmail", _userEmail);
  }

  checkPassword() async {
    SharedPreferences p = await SharedPreferences.getInstance();

    if (p.getString("carePassword") != null &&
        p.getString("careEmail") != null) {
      userEmail.text = p.getString("careEmail")!;
      userPassword.text = p.getString("carePassword")!;
      setState(() {});
    }
  }
